            ...
            <div className={`absolute inset-0 z-20 p-8 md:p-12 flex flex-col justify-between transition-all duration-500 bg-black/40 hover:bg-black/20 ${!isClickable ? 'opacity-50' : ''}`}>
                <div className="flex justify-between items-start pointer-events-none">
                    ...
                    <div className="flex items-center gap-3 pointer-events-auto">
                        {/* Live URL arrow - Visual Only (handled by stretched link) */}
                        {isClickable ? (
                            <div
                        ...
                        {project.githubUrl && (
                            <a
                                ...
                                className="p-3 rounded-full border border-white/20 text-white opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 hover:bg-white/10 relative z-30"
                            >
                ...
                <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500 pointer-events-none">
